<?php
session_start();
require '../model/registrationDB.php'; // $conn
require '../model/changePassDB.php';    // checkLogin()
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $successURL = "Location: ../View/login.php";
    $errorURL   = "Location: ../View/changePassword.php?";
